import{h as _,j as d,k as p,ak as u,c as m,al as h,m as n,am as t,an as s,z as o,F as f,ao as g,ap as v,aq as x,q as r,ar as y,as as k,n as b,at as N,au as P,_ as j}from"./nav-2401f1e9.js";import{N as w}from"./NoteDisplay-e1cc996b.js";import{u as S}from"./index-3a4cefe6.js";const V={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},z={class:"opacity-50"},B={class:"text-lg"},C={class:"font-bold flex gap-2"},D={class:"opacity-50"},H=t("div",{class:"flex-auto"},null,-1),q={key:0,class:"border-gray-400/50 mb-8"},F=_({__name:"PresenterPrint",setup(M){d(p),u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
